...
int
number_of_digits(const long number)
{
	long res = number;
...
int *
card_into_array(const long card, const int length)
{
	long number = card;
...
int
at_index(const int *card_array, const int length, int index)
{
...
bool
is_valid(const int *card_array, const int length)
{
	int sum_a = 0;
	int sum_b = 0;
	int sum = 0;
